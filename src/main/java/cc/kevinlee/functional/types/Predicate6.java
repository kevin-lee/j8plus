...
public interface Predicate6<T1, T2, T3, T4, T5, T6> {
   ...
   */
  boolean test(final T1 input1, final T2 input2, final T3 input3, final T4 input4, final T5 input5, final T6 input6);
   ...
   */
  default Predicate5<T2, T3, T4, T5, T6> curried(final T1 t1) {
   ...
   *           if other is null
   */
  default Predicate6<T1, T2, T3, T4, T5, T6> and(
      final Predicate6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6> other) {
    Objects.requireNonNull(other);
    /* @formatter:off */
    return
        (final T1 input1, final T2 input2, final T3 input3, final T4 input4, final T5 input5, final T6 input6) ->
          test(input1, input2, input3, input4, input5, input6) &&
          other.test(input1, input2, input3, input4, input5, input6);
    /* @formatter:on */
  }
   ...
   *           if other is null
   */
  default Predicate6<T1, T2, T3, T4, T5, T6> or(
      final Predicate6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6> other) {
    Objects.requireNonNull(other);
    /* @formatter:off */
    return
