...
public interface Predicate9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
   ...
   */
  boolean test(final T1 input1, final T2 input2, final T3 input3, final T4 input4, final T5 input5, final T6 input6, final T7 input7,
      final T8 input8, final T9 input9);
   ...
   */
  default Predicate8<T2, T3, T4, T5, T6, T7, T8, T9> curried(final T1 t1) {
    return (t2, t3, t4, t5, t6, t7, t8, t9) -> test(t1, t2, t3, t4, t5, t6, t7, t8, t9);
  }
   ...
   *           if other is null
   */
  default Predicate9<T1, T2, T3, T4, T5, T6, T7, T8, T9> and(
      final Predicate9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9> other) {
    Objects.requireNonNull(other);
    /* @formatter:off */
    return
        (final T1 input1, final T2 input2, final T3 input3, final T4 input4, final T5 input5,
         final T6 input6, final T7 input7, final T8 input8, final T9 input9) ->
          test(input1, input2, input3, input4, input5, input6, input7, input8, input9) &&
          other.test(input1, input2, input3, input4, input5, input6, input7, input8, input9);
    /* @formatter:on */
  }
   ...
   *           if other is null
   */
  default Predicate9<T1, T2, T3, T4, T5, T6, T7, T8, T9> or(
      final Predicate9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9> other) {
    Objects.requireNonNull(other);
    /* @formatter:off */
    return
