...
public interface Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
  R apply(T1 input1, T2 input2, T3 input3, T4 input4, T5 input5, T6 input6, T7 input7, T8 input8);
  ...
  default <V> Function8<T1, T2, T3, T4, T5, T6, T7, T8, V> andThen(final Function<? super R, ? extends V> after) {
    ...
    return (input1, input2, input3, input4, input5, input6, input7, input8) ->
                after.apply(apply(input1, input2, input3, input4, input5, input6, input7, input8));
    /* @formatter:on */
  }
}
