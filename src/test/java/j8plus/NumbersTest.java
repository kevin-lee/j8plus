...
import static testosterone.Testosterone.throwing;
...
public class NumbersTest {
  ...
  public final void testBigIntBigInteger() {
    /* given */
    final BigInteger number = new BigInteger("1");
    final Numbers.BigIntegerNumber expected = new Numbers.BigIntegerNumber(new BigInteger("1"));

    /* when */
    final Numbers.BigIntegerNumber actual = Numbers.bigInt(number);
  ...
  public final void testBigIntBigInteger2() {
    /* given */
    final BigInteger number = new BigInteger("1");
    final Numbers.BigIntegerNumber expected = new Numbers.BigIntegerNumber(new BigInteger("0"));
  ...
  public final void testBigIntString() {
    ...
    final Numbers.BigIntegerNumber expected = new Numbers.BigIntegerNumber(new BigInteger(number));
  ...
  public final void testDecimalBigDecimal() {
    /* given */
    final String number = "1";
    final Numbers.BigDecimalNumber expected = new Numbers.BigDecimalNumber(new BigDecimal(number));

    /* when */
    final Numbers.BigDecimalNumber actual = Numbers.decimal(new BigDecimal(number));
  ...
  public final void testDecimalBigDecimal2() {
    /* given */
    final String number = "1";
    final Numbers.BigDecimalNumber expected = new Numbers.BigDecimalNumber(new BigDecimal("0"));
  ...
  public final void testDecimalString() {
    ...
    /* when */
    final Numbers.BigDecimalNumber actual = Numbers.decimal(number);
