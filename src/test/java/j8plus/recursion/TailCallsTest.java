...
public class TailCallsTest {
  ...
  public final void testTrampoline1() {
    ...
    final BigInteger actual = TailCalls.trampoline(factorial(BigInteger.ONE, new BigInteger("1000")));
  ...
  public final void testTrampoline2() {
    ...
    /* when */
    final long start = System.currentTimeMillis();
    final BigInteger actual = TailCalls.trampoline(nThTriangularNumber(BigInteger.ZERO, new BigInteger(number)));
    System.out.println("It took " + (System.currentTimeMillis() - start) + "ms.");
  ...
  public final void testTrampoline3() {
    ...
    /* when */
    final long start = System.currentTimeMillis();
    final int actual = TailCalls.trampoline(howManyEven(0, 12345));
    System.out.println("It took " + (System.currentTimeMillis() - start) + "ms.");
