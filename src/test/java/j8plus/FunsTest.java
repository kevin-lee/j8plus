...
public class FunsTest {
  ...
  public final void testNot2() {
    ...
    final List<Integer> actual = numbers.stream()
        .filter(Funs.not(negativeNumber))
        .collect(toList());
  ...
  public final void testNot3() {
    ...
    /* when */
    final List<Integer> actual = numbers.stream()
        .filter(Funs.not(FunsTest::positiveNumber))
        .collect(toList());
  ...
  public final void testReversed() {
    ...
    /* when */
    final List<Integer> actual = numbers.stream()
        .sorted(Funs.reversed(Integer::compareTo))
        .collect(toList());
  ...
  public final void testReversedWithoutStream() {
    ...
    final Comparator<Integer> reversedIntegerComparator = Funs.reversed(integerComparator);
  ...
  public final void testReversed2() {
    ...
    /* when */
    final List<Integer> actual = numbers.stream()
        .sorted(Funs.reversed(descendingOrder))
        .collect(toList());
  ...
  public final void testReversed3() {
    ...
    /* when */
    final List<Integer> actual = numbers.stream()
        .sorted(Funs.reversed(this::ascendingOrder))
        .collect(toList());
  ...
  public void testComparing() {
    ...
    final List<SomeBean> actual = Arrays.asList(someBean3, someBean1, someBean2)
        .stream()
        .sorted(Funs.comparing(SomeBean::getDateCreated))
        .collect(toList());
  ...
  public void testComparingReversed() {
    ...
    final List<SomeBean> actual = Arrays.asList(someBean1, someBean2, someBean3)
        .stream()
        .sorted(Funs.reversed(Funs.comparing(SomeBean::getDateCreated)))
        .collect(toList());
  ...
  public void testComparingLt() {
    ...
    /* when */
    final int actual = Funs.comparing(SomeBean::getDateCreated).compare(madeYesterday, willBeMadeTomorrow);
  ...
  public void testComparingGt() {
    ...
    /* when */
    final int actual = Funs.comparing(SomeBean::getDateCreated).compare(willBeMadeTomorrow, madeYesterday);
  ...
  public void testToStringOf() {
    ...
    final String actual = numbers.stream()
        .map(Funs.toStringOf(TestValue::getId))
        .collect(joining(", ", "[", "]"));
  ...
  public void testSatisfying() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1);
  ...
  public void testSatisfyingWithStream() {
    ...
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1))
        .collect(toList());
  ...
  public void testSatisfying2() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying2WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2))
        .collect(toList());
  ...
  public void testSatisfying3() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying3WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3))
        .collect(toList());
  ...
  public void testSatisfying4() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying4WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4))
        .collect(toList());
  ...
  public void testSatisfying5() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying5WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5))
        .collect(toList());
  ...
  public void testSatisfying6() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying6WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6))
        .collect(toList());
  ...
  public void testSatisfying7() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying7WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7))
        .collect(toList());
  ...
  public void testSatisfying8() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7, param8);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying8WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7, param8))
        .collect(toList());
  ...
  public void testSatisfying9() {
    ...
    /* when */
    final Predicate<TestBean> predicate = Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7, param8, param9);
    final boolean actual = predicate.test(testBean1);
  ...
  public void testSatisfying9WithStream() {
    ...
    /* when */
    final List<TestBean> actual = expected.stream()
        .filter(Funs.satisfying(TestBean::isOk, param1, param2, param3, param4, param5, param6, param7, param8, param9))
        .collect(toList());
  ...
  public void testApplyingWithStream() {
    ...
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1))
        .collect(toList());
  ...
  public void testApplying2WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2))
        .collect(toList());
  ...
  public void testApplying3WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3))
        .collect(toList());
  ...
  public void testApplying4WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4))
        .collect(toList());
  ...
  public void testApplying5WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4, param5))
        .collect(toList());
  ...
  public void testApplying6WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4, param5, param6))
        .collect(toList());
  ...
  public void testApplying7WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4, param5, param6, param7))
        .collect(toList());
  ...
  public void testApplying8WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4, param5, param6, param7, param8))
        .collect(toList());
  ...
  public void testApplying9WithStream() {
    ...
    /* when */
    final List<String> actual = list.stream()
        .map(Funs.applying(TestBean::call, param1, param2, param3, param4, param5, param6, param7, param8, param9))
        .collect(toList());
  ...
  public void testAcceptingWithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1));
  ...
  public void testAccepting2WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2));
  ...
  public void testAccepting3WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3));
  ...
  public void testAccepting4WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4));
  ...
  public void testAccepting5WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4, param5));
  ...
  public void testAccepting6WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4, param5, param6));
  ...
  public void testAccepting7WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4, param5, param6, param7));
  ...
  public void testAccepting8WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4, param5, param6, param7, param8));
  ...
  public void testAccepting9WithStream() {
    ...
    Arrays.asList(testBean1, testBean2, testBean3)
        .stream()
        .forEach(Funs.accepting(TestBean::run, param1, param2, param3, param4, param5, param6, param7, param8, param9));
